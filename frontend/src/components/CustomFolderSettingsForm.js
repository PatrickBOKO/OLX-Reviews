...
export default function CustomFolderSettingsForm({ open, onClose, onSave }) {
  const [form, setForm] = useState({
    ...
    template: `Hello,
We noticed you recently interacted with us by email.
...
Thank you!`
  ...
  return (
    <div className="settings-modal-overlay" onClick={onClose}>
      <div
        className="block form-container custom-folder-settings-form"
        onClick={e => e.stopPropagation()}
      >
        <h2>Custom Folder Review Settings</h2>
        <div className="custom-folder-settings-description">
          Define settings for automatically collecting reviews for <strong>Custom Folder</strong>
          <span style={{ fontWeight: 400 }}> (based on emails received in your custom folder)</span>
        </div>
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="e.g. Project Reviews"
          />
          ...
          <div className="buttons custom-folder-settings-buttons">
            ...
            <button
              type="button"
              className="custom-folder-close-btn"
              style={{
                marginLeft: "auto",
                background: "#f8f9fa",
                color: "#374151",
